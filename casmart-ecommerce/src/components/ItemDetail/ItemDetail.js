        ...
        <section className="details section--lg">
            <div className="details__container container--detail grid">
                ...
                <div className="details__group">
                    ...
                    {item.stock > 0 ? <ItemCount count={count} handleDecrement={handleDecrement} handleIncrement={handleIncrement} handleAddToCart={() => {addToCart(item, count)}} handleAddToWishlist={() => {addToWishlist(item)}}/> : <h3 className="section__title">El producto se encuentra agotado</h3>}
